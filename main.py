...
st.subheader("Bar Chart of Top 3 Tenured Employee")
fig = px.histogram(df444, x='Employee Name', y='Tenure in doodleblue', title="Bar Chart of Top 3 Tenured Employee")
st.plotly_chart(fig,use_container_width=True)

st.subheader("Pie Chart for Willing to go to Blore office")
fig = px.pie(MMA1, names='Willing to go to Blore office', values='Count', title="Pie Chart for Willing to go to Blore office")
st.plotly_chart(fig,use_container_width=True)


st.subheader("Designation wise Relocation Stacked Bar Chart")
fig = px.histogram(category_df3, x=category_df3["Designation"], color="Willing to go to Blore office", title="Stacked Bar Chart Analysis vs Designation")
st.plotly_chart(fig,use_container_width=True)

st.subheader("Pie Chart for Current Unit ")
fig = px.pie(MMA, names='Unit', values='Count', hole=0.3,title="Pie Chart of Current Unit")
st.plotly_chart(fig,use_container_width=True)


st.subheader("Current Unit wise Relocation")
