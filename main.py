...
with col1:
    st.metric(label="", value=numeric_value1444)
...
fig = px.pie(MMA, names='Unit', values='Count', hole=0.3,title="Current Unit")
st.plotly_chart(fig,use_container_width=True)
...
fig = px.histogram(category_df5, x=category_df5["Primary Skills"], color="Willing to go to Blore office", title="Primary Skill wise Relocatio")
st.plotly_chart(fig,use_container_width=True)

st.subheader("Secondary Skill wise Relocation")
fig = px.histogram(category_df6, x=category_df6["Secondary Skills"], color="Willing to go to Blore office", title="Secondary Skill wise Relocatio")
st.plotly_chart(fig,use_container_width=True)

st.subheader("Work Mode wise Relocation")
fig = px.histogram(category_df7, x=category_df7["Work mode (WFH / WFO / WFCO / Hybrid)"], color="Willing to go to Blore office", title="Work Mode wise Relocatio")
st.plotly_chart(fig,use_container_width=True)
