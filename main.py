...
all_workmode= ['All'] + list(df['Work mode (WFH / WFO / WFCO / Hybrid)'].unique())
selected_gender = st.sidebar.selectbox("Select Work Mode", all_workmode, index=0)
if selected_gender != 'All':
    filtered_df = filtered_df[filtered_df['Work mode (WFH / WFO / WFCO / Hybrid)'] == selected_gender]
